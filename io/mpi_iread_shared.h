#ifndef __LAT_MPI_IREAD_SHARED__
#define __LAT_MPI_IREAD_SHARED__

/* Public interface */
#define LAT_FD      MPI_File

#define LAT_FILE_METHODOLOGY_STRING "MPI_File_iread_shared()/MPI_Wait()"
#define LAT_FILE_METHODOLOGY        LAT_mpi_iread_shared
...
/* internal interfaces */
#define LAT_FILE_MEASUREMENT       LAT_mpi_iread_shared_test
...
#define LAT_FILE_MEASUREMENT_INIT_FN(_c) MPI_File_iread_shared(_c.fd,_c.buf,_c.cnt,_c.dat,&_c.req)
