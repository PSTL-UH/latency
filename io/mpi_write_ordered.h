#ifndef __LAT_MPI_WRITE_ORDERED__
#define __LAT_MPI_WRITE_ORDERED__

/* Public interface */
#define LAT_FD      MPI_File

#define LAT_FILE_METHODOLOGY_STRING "MPI_File_write_ordered()"
#define LAT_FILE_METHODOLOGY        LAT_mpi_write_ordered
...
/* internal interfaces */
#define LAT_FILE_MEASUREMENT       LAT_mpi_write_ordered_test
...
#define LAT_FILE_MEASUREMENT_INIT_FN(_c) {    \
  MPI_Status _status;                         \
  MPI_File_write_ordered ( _c.fd, _c.buf, _c.cnt, _c.dat, &_status); \
} 

#define LAT_FILE_MEASUREMENT_FIN_FN(_c) 

#endif /* __LAT_MPI_WRITE_ORDERED__ */
