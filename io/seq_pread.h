#ifndef __LAT_SEQ_PREAD__
#define __LAT_SEQ_PREAD__

/* Public interface */
#define LAT_FD      int

#define LAT_FILE_METHODOLOGY_STRING "sequential pread()"
#define LAT_FILE_METHODOLOGY        LAT_seq_pread
...
/* internal interfaces */
#define LAT_FILE_MEASUREMENT       LAT_seq_pread_test
...
#define LAT_FILE_MEASUREMENT_INIT_FN(_c ) {     \
  ...
  size_t _num = _c.len ;                        \
  do {                                          \
    _a = pread ( _c.fd, _c_ptr, _num, _c.offset ); \
    if ( _a == -1 ) {                           \
