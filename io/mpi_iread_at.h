#ifndef __LAT_MPI_IREAD_AT__
#define __LAT_MPI_IREAD_AT__

/* Public interface */
#define LAT_FD      MPI_File

#define LAT_FILE_METHODOLOGY_STRING "MPI_File_iread_at()/MPI_Wait()"
#define LAT_FILE_METHODOLOGY        LAT_mpi_iread_at
...
/* internal interfaces */
#define LAT_FILE_MEASUREMENT       LAT_mpi_iread_at_test
...
#define LAT_FILE_MEASUREMENT_INIT_FN(_c) MPI_File_iread_at(_c.fd, (MPI_Offset) _c.offset,_c.buf,_c.cnt,_c.dat,&_c.req)
