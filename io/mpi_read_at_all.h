...
#define LAT_FILE_METHODOLOGY_STRING "MPI_File_read_at_all()"
#define LAT_FILE_METHODOLOGY        LAT_mpi_read_at_all
...
/* internal interfaces */
#define LAT_FILE_MEASUREMENT       LAT_mpi_read_at_all_test
...
#define LAT_FILE_MEASUREMENT_INIT_FN(_c) {    \
  MPI_Status _status;                         \
  MPI_File_read_at_all ( _c.fd, _c.offset, _c.buf, _c.cnt, _c.dat, &_status); \
  _c.offset += _c.cnt; \
} 
