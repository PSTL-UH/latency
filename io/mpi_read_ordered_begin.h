#ifndef __LAT_MPI_READ_ORDERED_BEGIN__
#define __LAT_MPI_READ_ORDERED_BEGIN__

/* Public interface */
#define LAT_FD      MPI_File

#define LAT_FILE_METHODOLOGY_STRING "MPI_File_read_ordered_begin()/MPI_File_read_ordered_end()"
#define LAT_FILE_METHODOLOGY        LAT_mpi_read_ordered_begin
...
/* internal interfaces */
#define LAT_FILE_MEASUREMENT       LAT_mpi_read_ordered_begin_test
...
#define LAT_FILE_MEASUREMENT_INIT_FN(_c) MPI_File_read_ordered_begin(_c.fd,_c.buf,_c.cnt,_c.dat)

#define LAT_FILE_MEASUREMENT_FIN_FN(_c) {\
  MPI_Status _status;                    \
  MPI_File_read_ordered_end(_c.fd, _c.buf, &_status); \
}

#endif /* __LAT_MPI_READ_ORDERED_BEGIN__ */
