...
#define LAT_FILE_METHODOLOGY_STRING "MPI_File_write_at_all_begin()/MPI_File_write_at_all_end()"
#define LAT_FILE_METHODOLOGY        LAT_mpi_write_at_all_begin
...
/* internal interfaces */
#define LAT_FILE_MEASUREMENT       LAT_mpi_write_at_all_begin_test
...
#define LAT_FILE_MEASUREMENT_INIT_FN(_c) MPI_File_write_at_all_begin(_c.fd,_c.offset,_c.buf,_c.cnt,_c.dat)

#define LAT_FILE_MEASUREMENT_FIN_FN(_c ) {\
  MPI_Status _status;                     \
  MPI_File_write_at_all_end(_c.fd, _c.buf, &_status); \
  _c.offset += _c.cnt; \
}
