#ifndef __LAT_MPI_READ_SHARED__
#define __LAT_MPI_READ_SHARED__

/* Public interface */
#define LAT_FD      MPI_File

#define LAT_FILE_METHODOLOGY_STRING "MPI_File_read_shared()"
#define LAT_FILE_METHODOLOGY        LAT_mpi_read_shared
...
/* internal interfaces */
#define LAT_FILE_MEASUREMENT       LAT_mpi_read_shared_test
...
#define LAT_FILE_MEASUREMENT_INIT_FN(_c) {    \
  MPI_Status _status;                         \
  MPI_File_read_shared ( _c.fd, _c.buf, _c.cnt, _c.dat, &_status); \
} 
