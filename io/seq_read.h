#ifndef __LAT_SEQ_READ__
#define __LAT_SEQ_READ__

/* Public interface */
#define LAT_FD      int

#define LAT_FILE_METHODOLOGY_STRING "sequential read()"
#define LAT_FILE_METHODOLOGY        LAT_seq_read
...
/* internal interfaces */
#define LAT_FILE_MEASUREMENT       LAT_seq_read_test
