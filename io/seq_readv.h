#ifndef __LAT_SEQ_READV__
#define __LAT_SEQ_READV__

/* Public interface */
#define LAT_FD      int

#define LAT_FILE_METHODOLOGY_STRING "sequential readv()"
#define LAT_FILE_METHODOLOGY        LAT_seq_readv
...
/* internal interfaces */
#define LAT_FILE_MEASUREMENT       LAT_seq_readv_test
