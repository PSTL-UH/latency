...
#define LAT_COMMUNICATION_METHODOLOGY_STRING "MPI_Put/MPI_Win_fence using duplex mode"
#define LAT_COMMUNICATION_METHODOLOGY        LAT_put_winfence_duplex
...
#define LAT_BANDWIDTH_MEASUREMENT_SEND       LAT_band_sput_winfence_duplex
#define LAT_BANDWIDTH_MEASUREMENT_RECV       LAT_band_rput_winfence_duplex
