...
#define LAT_COMMUNICATION_METHODOLOGY_STRING "MPI_Get/MPI_Win_start/post"
#define LAT_COMMUNICATION_METHODOLOGY        LAT_get_startpost
...
#define LAT_BANDWIDTH_MEASUREMENT_SEND       LAT_band_sget_startpost
#define LAT_BANDWIDTH_MEASUREMENT_RECV       LAT_band_rget_startpost
