...
#define LAT_COMMUNICATION_METHODOLOGY_STRING "MPI_Send/MPI_Irecv"
#define LAT_COMMUNICATION_METHODOLOGY        LAT_send_irecv
...
/* internal interfaces */
#define LAT_LATENCY_MEASUREMENT_SEND         LAT_send
#define LAT_LATENCY_MEASUREMENT_RECV         LAT_irecv
#define LAT_BANDWIDTH_MEASUREMENT_SEND       LAT_band_send
...
#define LAT_LATENCY_MEASUREMENT_SEND_FN(_c) {                            \
   MPI_Request _req;                                                     \
   MPI_Status _stat;                                                     \
   MPI_Irecv (_c.rbuf, _c.cnt, _c.dat, _c.partner, 4712, _c.obj, &_req); \
   MPI_Send  (_c.sbuf, _c.cnt, _c.dat, _c.partner, 4712, _c.obj);        \
   MPI_Wait  (&_req, &_stat);                                            \
}
