...
#define LAT_COMMUNICATION_METHODOLOGY_STRING "MPI_Get/MPI_Win_fence"
#define LAT_COMMUNICATION_METHODOLOGY        LAT_get_winfence
...
#define LAT_BANDWIDTH_MEASUREMENT_SEND       LAT_band_sget_winfence
#define LAT_BANDWIDTH_MEASUREMENT_RECV       LAT_band_rget_winfence
