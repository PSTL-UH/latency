...
#define LAT_COMMUNICATION_METHODOLOGY_STRING "MPI_Put/MPI_Win_start/post using duplex communication"
#define LAT_COMMUNICATION_METHODOLOGY        LAT_put_startpost_duplex
...
#define LAT_BANDWIDTH_MEASUREMENT_SEND       LAT_band_sput_startpost_duplex
#define LAT_BANDWIDTH_MEASUREMENT_RECV       LAT_band_rput_startpost_duplex
